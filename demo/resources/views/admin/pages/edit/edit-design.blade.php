        ...
        <div class="universal-slider">
            <div class="static-image">
                <label for="design-advert" class="admin-image-wrapper d-flex">
                    ...
                    <input type="file" accept="image/png, image/jpeg" class="ajax-input d-none" name="design_advert" id="design-advert">
                </label>
            </div>
...
{{-- Divider Line --}}
    <div class="my-md-5 my-3 remove-on-mobile">
    ...
    <div class="form-section">
        <div class="design-wrapper">
            <div class="design-bottom-section">
                ...
                @if ( $data['bottom_text'] != [] )
                    <div class="important-text-wrapper">
                        <h5 contenteditable="true" data-text-to-value="#design-bottom-title" class="important-text">{{ $data['bottom_text'][0]['title'] }}</h5>
                    </div>
                    <p contenteditable="true" data-text-to-value="#design-bottom-text">{{ $data['bottom_text'][0]['text'] }}</p>

                    <input type="hidden" id="design-bottom-title" name="design_bottom_title" value="{{ ($data['bottom_text'][0]['title']) }}">
                    <input type="hidden" id="design-bottom-text" name="design_bottom_text" value="{{ $data['bottom_text'][0]['text'] }}">
                @else
                    <div class="important-text-wrapper">
                        <h5 contenteditable="true" data-text-to-value="#design-bottom-title" class="important-text">სათაური</h5>
                    </div>
                    <p contenteditable="true" data-text-to-value="#design-bottom-text">აღწერა</p>
                    
                    <input type="hidden" id="design-bottom-title" name="design_bottom_title">
                    <input type="hidden" id="design-bottom-text" name="design_bottom_text">
                @endif

                <h5 class="mt-4 mb-3 text-center">დააჭირეთ სურათებს რომ შეცვალოთ</h5>

                <div class="bottom-images-wrapper">
                    <div>
                        <label for="design-left-pic" class="admin-image-wrapper d-flex">
                            @if ( $data['design_left_pic'] != [] )
                                @foreach ( $data['design_left_pic'] as $left_pic )
                                    <img class="ajax-image w-100" src="{{ asset($left_pic['image']) }}">
                                @endforeach
                            @else
                                <img class="ajax-image w-100" src="{{ asset('images/temp/no-image.jpg') }}">
                            @endif
                            ...
                            <input type="file" accept="image/png, image/jpeg" class="ajax-input d-none" name="design_left_pic" id="design-left-pic">
                        </label>
                        <span>რენდერი</span>
                    </div>
                    <div>
                        <label for="design-right-pic" class="admin-image-wrapper d-flex">
                            @if ( $data['design_right_pic'] != [] )
                                @foreach ( $data['design_right_pic'] as $right_pic )
                                    <img class="ajax-image w-100" src="{{ asset($right_pic['image']) }}">
                                @endforeach
                            @else
                                <img class="ajax-image w-100" src="{{ asset('images/temp/no-image.jpg') }}">
                            @endif
                            ...
                            <input type="file" accept="image/png, image/jpeg" class="ajax-input d-none" name="design_right_pic" id="design-right-pic">
                        </label>
                        <span>რეალობა</span>
                    </div>
                </div>
