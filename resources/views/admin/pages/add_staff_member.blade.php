            ...
            <div class="container-800 d-fc">
                ...
                <div class="s-collapse d-fc show" id="meta">
                    <div class="form-section d-fc">
                        ...
                        <input class="form-control" type="text" name="name" placeholder="სახელი" value="" maxlength="60" required>
                    </div>
                    <div class="form-section d-fc">
                        <h5 class="mt-3">ლოგინი</h5>
                        <span class="letter-counter">0/60</span>
                        <input class="form-control" type="text" name="login" placeholder="ლოგინი" value="" maxlength="60" required>
                    </div>
                    <div class="form-section d-fc">
                        <h5 class="mt-3">პაროლი</h5>
                        <span class="letter-counter">0/60</span>
                        <input class="form-control" type="text" name="password" placeholder="პაროლი" value="" maxlength="60" required>
                    </div>
