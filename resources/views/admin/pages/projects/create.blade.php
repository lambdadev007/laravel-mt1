                ...
                <!-- mobile video section  -->
                 ...
                 <div class="form-check pl-0 d-flex">
                   ...
                   <div class="form-check form-check-inline pl-3 d-flex">
                    ...
                    <div class="pt-5">
                        <div class="">
                           <input class="form-check-input" type="checkbox" name="show_on_homepage" id="inlineRadio2" value="1">
                           <label class="form-check-label" for="inlineRadio2">აჩვენე პროექტი მთავარ გვერდზე</label>
                        </div>
                        <div class="">
                            <input class="form-check-input" type="checkbox" name="show_on_servicepage"  value="1">
