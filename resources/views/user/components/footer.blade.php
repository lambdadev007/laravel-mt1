            ...
            @if ( !$agent->isMobile() ) {{-- Needs to be reverse --}}
                <div class="left footer-section">
                    <div class="links d-fc">
                        ...
                        @else
                            <a href="{{ $company_hotline['call_phone_number'] }}" role="button" class="gray-text">+995 {{ $company_hotline['visible_phone_number'] }}</a>
                        @endif
                        {{-- @if ( isset($vip_number_toggle) )
                            <a href="tel:+995597701010" role="button" class="gray-text">+995 597 10 40 40</a>
                        @else
                        @endif --}}
