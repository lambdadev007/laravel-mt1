...
@endif
@if (Session::has('terms_checks'))
    <div class="alert alert-danger text-center">ვეთანხმები პირობებს</div>
@endif
...
@endif
@if (Session::has('invoice_sent'))
    <div class="alert alert-success text-center">ინვოისი წარმატებულად გაიგზავნა თქვენს ელ.ფოსტაზე</div>
@endif
@if (Session::has('invoice_already_sent'))
    <div class="alert alert-danger text-center">თქვენ უკვე გააგზავნეთ ინვოისი, ახალი ინვოისის მოთხოვნა შეგიძლიათ სცადოთ მოგვიანებით.</div>
@endif