        ...
        <div class="modal-content register flex-row">
            ...
            <div class="right d-fc w-100">
                ...
                <form class="form d-fc" action="/user/register" method="post">
                    ...
                    <div class="site-terms d-flex" style="justify-content: initial;">
                        <label class="universal-checkbox-wrapper terms  m-1 p-2"><input type="checkbox" name="terms" required style="position: absolute;top: -1px;left: 0px;width: 100%;height: 100%;border: 1px solid rgb(var(--metrix-yellow-accent));"> <div class="before" style="display: none;" ></div> <div class="after" style="display: none;" ></div></label>

                        <span>{{ $tranCT->translate('i_agree') }}  <a href="#" role="button" data-toggle="modal" data-target="#terms-modal">საიტის წესებს</a> </span>
                ...
                <!-- <div class="site-terms d-fc">
                    ...
                    <a href="#" role="button" data-toggle="modal" data-target="#terms-modal">საიტის წესებს</a>
                </div> -->
                {{-- <div class="or-divider">
                    <div class="left"></div>
                    <span class="text">ან</span>
