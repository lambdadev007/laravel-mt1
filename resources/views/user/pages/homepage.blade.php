...
<style>
    ...
    <div class="homepage-wrapper d-fc">
        ...
        <div class="homepage-video-wrapper d-flex container-1280 new-section-home justify-content-between pl-3">
...
-->
        ...
        <div class="d-flex container-1280 pt-5 pb-5 cat-div-mobile">
            <div class="row m-0 justify-content-between pl-4 desktop-small">
            ...
            <div class="col-md-5 home-cat ser " id="service-designer" style="display: none;">
                <div class="right-box  cat-rightbox-custom">
                    ...
                    <div class="remove-padding">
                     <!--   <p class="w-100 pt-4 "> {{ $data['designer']['meta_description'] }}</p> -->
                     
                    </div>
                    @endif
                    <div class="remove-padding">
                        <p class="w-100 pt-3 "></p>
                    </div> 
                    <div class="remove-padding">
                        <p class="w-100 pt-4 ">არასწორი დაპროექტებით თქვენი ბინა შესაძლოა, ნაკლებად ფუნქციური და არაესთეტიკური გამოჩნდეს. დიდია ალბათობა, რომ შეუსაბამო განათებამ, ცუდად დაგეგმილმა გაყვანილობებმა თუ შეუფერებელმა ავეჯმა თქვენი ინტერიერი ერთ დიდ გაუგებრობად აქციოს და ყოველდღიური ცხოვრება გაგირთულოთ. ინტერიერისა თუ ლანდშაპტის დიზაინერის მომსახურებით საცხოვრებელ სივრცეს უფრო კომფორტულსა და ადაპტირებულს გახდით. მისი დახმარებით თქვენს სურვილებსა თუ საჭიროებებს რეალობად აქცევთ და 3D დიზაინის სახით წინასწარაც შეავლებთ თვალს. 
</p>
                    </div> 
                    <div class="remove-padding">
                        <p class="w-100 pt-3 ">Metrix-ის დიზაინერი თქვენთან შეთანხმებით შეასრულებს აზომვით სამუშაოებს, უზრუნველყოფს სწორ დაგეგმარებას და თქვენი გემოვნების შესაბამისად შეარჩევს დიზაინის სტილს. რაც მთავარია, სურვილის შემთხვევაში, აქტიურად იქნება ჩართული მიმდინარე პროცესებში და საჭირო მასალის შეძენაშიც დაგეხმარებათ.</p>
                    </div> 
                    <div class="home-button-space-bot">
            ...
            <div class="col-md-5 home-cat ser" id="service-vip"  style="display: none;">
                <div class="right-box  cat-rightbox-custom">
                  ...
                  <!--  <div class="remove-padding">
                    ...
                    @endif
                   <div class="remove-padding">
                        <p class="w-100 pt-4 "> თანამედროვე სამყაროში მომსახურება, რომელიც დროსა და ენერგიას დაგიზოგავთ, ყველაზე მეტად ფასობს. დღეს აღარ გჭირდებათ, ხელოსნის მოსაძებნად ელიავაზე ირბინოთ. მისი გამოძახება Metrix-ის დახმარებით მეტად მარტივი და კომფორტულია. Metrix გთავაზობთ ხელოსნის გამოძახების სერვისს ნებისმიერი ტიპის სამუშაოსთვის. იქნება ის სანტექნიკა, გათბობა/კონდიცირება, ელექტროობა, საყოფაცხოვრებო ტექნიკა თუ სახლის კინოთეატრის მონტაჟი.   </p>

                    </div>
                    <div class="remove-padding">
                        <p class="w-100 pt-3 ">Metrix-ის VIP მასტერის გამოძახება 24/7-ზე თბილისის ნებისმიერ უბანშია შესაძლებელი. ისინი ნებისმიერი სირთულის სამუშაოს დროულად, ყოველგვარი გართულების გარეშე შეასრულებენ. რაც მთავარია, თქვენი თანხმობის შემთხვევაში სამუშაოსთვის საჭირო მასალას თავად შეიძენენ და ამ დისკომფორტსაც თავიდან აგაცილებენ.</p>
                    </div>
